...
<body>
        ...
        <table class="highlight">
            ...
            ?>
                ...
                <tr>
                    ...
                    <td><a href="delcart.php?idcart=<?php echo $i?>">Xóa</a></td>                
                </tr>
                </tbody>
            <?php
            $i+=1;
    ...
    <div class="row">
        <div class="col s12 m4 l2"></div>
        <div class="col s12 m4 l8"><a href="bill.php"><input type="submit" value="Tiếp tục đặt hàng" name="tieptuc" style="color:black;"></a></div>
        <div class="col s12 m4 l2"></div>
    </div>                    
</body>
